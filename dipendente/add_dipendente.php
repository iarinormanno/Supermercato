...
<body>
    ...
    <div class="topnav">
      ...
      <a href="/sito%20esame/dipendente/view_dipendente.php">Lista Dipendente</a>
    </div>
  
    <div class="content">
      <div class="center">
      <form name="form" action="insert_dipendente.php" method="GET" onsubmit="return controllo()">
        <h1>Aggiunta nuovo dipendente</h1>
        <h5>Informazioni Personali</h5>
        <div class="item">
        <div class="item">
          <input type="text" name="dipendente_id" placeholder="Dipendente ID"/>
        </div>
          <div class="name-item">
        ...
        <div class="item" id="myDIV">
            <select name="responsabile_id">
                    <option disabled selected>---Assegna Responsabile---</option>
                  <?php
                  include "connection.php";
                  $query = "WITH RECURSIVE rt AS(SELECT dipendente_id,responsabile_id from dipendente) select dipendente_id from rt where dipendente_id like 'c%' ";
