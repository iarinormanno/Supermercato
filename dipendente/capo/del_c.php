...
<body>
    ...
    <div class="content">
        <form name="form" action="del.php" method="GET" onsubmit="return controllo()"><br>
            Seleziona il codice identificato del Capo che si vuole elimanare:
                <select name="dipendente_id">
                    <option disabled selected>---Scegli Capo---</option>
                  <?php
                  include "connection.php";
                  $query = "SELECT dipendente_id FROM dipendente where dipendente_id like 'c%'";
