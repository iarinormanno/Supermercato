...
<body>
    ...
    <div class="content">
      <div class="center">
      <form name="form" action="add_capo.php" method="GET" onsubmit="return controllo()">
        <h1>Aggiunta nuovo dipendente</h1>
        <h5>Informazioni Personali</h5>
        <div class="item">
        <div class="item">
          <input type="text" name="dipendente_id" placeholder="Capo ID( mettere lettera 'c' davanti id)"/>
        </div>
          <div class="name-item">
