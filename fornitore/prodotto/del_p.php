...
<body>
    ...
    <div class="topnav">
      ...
      <a href="/sito%20esame/fornitore/prodotto/view_prodotto.php">Lista Prodotti</a>
    </div>


    <div class="content">
        <form name="form" action="delete_p.php" method="GET" onsubmit="return controllo()"><br>
            Seleziona il codice identificato del fornitore che si vuole elimanare:
